...
export default class ChangePassword extends Component {
  ...
  changePassword = () => {
    ...
    const oldP = this.olPInput.value.trim();
    let isError = false;
    ...
    if (!isError) {
      ...
      this.props.changePassword({ newPassword: currentP, existingPassword: oldP });
    ...
    return (
      <>
        <ListItem onClick={() => this.toggleDialog()} className="profile-list-4">
          ...
          <ListItemText primary="Password" secondary="xxxxxxx" />
          ...
          <div className="white-bg">
            <div className="create-store-form">
              <TextField
                ...
                inputRef={ref => this.olPInput = ref}
                error={this.state.form.oldP.error.isError}
                helperText={this.state.form.oldP.error.message}
            ...
            <div className="text-center pb-5">
              <Button variant="outlined" color="primary" onClick={() => this.changePassword()}>
                Change Password
              </Button>
            </div>
          </div>
